...
import { postSchema, postSchemaType } from "@/lib/zodShemas";
                ...
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <form onSubmit={(handleSubmit(onSubmit))} className="space-y-8">
                        ...
                        <div className="flex justify-center">
                            <Link to={`/board/view/${id}?page=${p}`} className="mr-5 py-3 px-5 text-sm font-medium text-center text-white rounded-lg  bg-blue-700 hover:bg-blue-800 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">취소하기</Link>
